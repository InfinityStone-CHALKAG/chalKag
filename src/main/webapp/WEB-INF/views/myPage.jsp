...
<section class="myPage">
    <div class="container">
                                ...
                                <div class="featured-author-center">
                                    <figure class="featured-author-picture">
                                        ...
                                        <img src="css/user/images/sponsored.png"
                                             alt="Sample Article" data-input="fileInput" style="cursor: pointer;">
        ...
        <div class="col-md-5 col-sm-12 col-xs-12"
            ...
            <div>기본정보 <i class="ion-ios-information-outline"
                         style="font-size: 16px; margin-bottom:15px"></i></div>

            <div style="display: flex; align-items: center;">
                <i class="ion-android-person" style="font-size: 58px;"></i>
                <div style="margin-left: 10px;">
                    <div class="memberName" id="memberName" style="font-size: 25px; font-weight: bold;">
                        정석진
                    </div>
        ...
        <!-- Start nav -->
        <div class="col-md-5 col-sm-12 col-xs-12" style="margin-left: 10px;">
            <nav class="menu">
                <div class="container">
                    <div id="menu-list">
                        <ul class="nav-list">
                ...
                <a href="#" class="btn btn-magz" style="text-transform: uppercase; font-weight: 500; margin-top:100px">BOOST<i
