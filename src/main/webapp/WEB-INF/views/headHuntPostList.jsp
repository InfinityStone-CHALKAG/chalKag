						...
						<div class="aside-body">
							...
							<div class="form-group">
								<label><input type="checkbox" id="headHunt"
									name="headHunt" checked> &nbsp; All Head Hunt</label>
							</div>
							...
							<!-- Pay 필터 -->
							<div class="form-group">
								<label for="minPrice">최소 Pay:</label> <input type="range"
									id="minPay" name="minPay" min="0" max="1000000" value="1">
								<label for="maxPrice">최대 Pay:</label> <input type="range"
				...
				<div class="col-md-9">
					<div class="nav-tabs-group">
						<ul class="nav-tabs-list">
							...
							<li onclick="sortItems('headHuntPostViewCnt')">Trending</li>
						</ul>
