						...
						<div class="row">
							...
							<div class="col-md-3">
								...
								<aside>
									...
									<div class="aside-body">
										<div class="group-title" style="font-weight: bold; margin-bottom: 2%;">DATE
										</div>
										<div class="form-group">
											<!-- 모든 시간 selectAll -->
										...
										<div class="form-group">
											<label for="minPrice">Min</label> <input type="range" id="minPay"
												name="minPay" min="0" max="1000000" value="1">
											<label for="maxPrice">Max</label> <input type="range" id="maxPay"
												name="maxPay" min="0" max="1000000" value="1">
										</div>
										<br>

										<!--  작업 날짜 필터 -->
										<div class="group-title" style="font-weight: bold; margin-bottom: 2%;">WORK DATE
										</div>
										<div class="form-group">
										...
										<!-- 촬영 컨셉 필터 -->
										<div class="group-title" style="font-weight: bold; margin-bottom: 2%;">WORK
											CONCEPT
										</div>
										<div class="form-group">
							...
							<div class="col-md-9">
								...
								<li><a href="#">Videos</a></li>
									...
									<div class="search-result">
										Define style with your exceptional models.
									</div>
								...
								<!-- 게시글 전체 갯수가 출력되게 처리 -->
									<div class="row">
										...
										<div id="postDatasContainer" data-displayreviewdata='${headHuntPostList}'></div>
										<!-- 게시글 목록 출력 장소 종료-->
										<!-- 페이지 이동 버튼 -->
