...
<head>
				...
				<div class="row">
					...
					<div class="col-md-8">
								...
								<div class="featured" style="margin-bottom: 3%; margin-top: 2%; display: block; justify-content: center;">
										<div>
											...
											<div  class="postInfo">
												...
												<div class="postInfoContents" id="jobHuntPostPay">${jobHuntPostSingle.jobHuntPostPay} ₩</div>
											</div>
											<div  class="postInfo">
						...
						<div  style="display: flex; justify-content: center;">
							<c:if test="${member != null && member == jobHuntPostSingle.memberId}">
								<a class="btn btn-primary" style="margin-right: 10px" href="/updateJobHuntPost?jobHuntPostId=${jobHuntPostSingle.jobHuntPostId}">Post Update</a>
								<a class="btn btn-primary" href="/deleteJobHuntPost?jobHuntPostId=${jobHuntPostSingle.jobHuntPostId}">Post Delete</a>
							</c:if>
						</div>
						<div class="line">
							<div>Author</div>
    ...
    // div 요소를 가져옵니다.
    const postPayElement = document.getElementById('jobHuntPostPay');
