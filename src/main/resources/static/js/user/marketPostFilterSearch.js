...
$(document).ready(function() {
	...
	// 최소 가격 설정 시 이벤트
	document.getElementById('minPrice').addEventListener('mouseup', handleFilterChange);
	// 최대 가격 설정 시 이벤트
	document.getElementById('maxPrice').addEventListener('mouseup', handleFilterChange);
	// 상품 종류 설정 시 이벤트 
	...
	document.getElementById('filterReset').addEventListener('click', function() {
		if (this.checked) {
			...
			// 모든 라디오 버튼을 가져옴
			var radioButtons = document.querySelectorAll('input[type="radio"][name="marketPostDate"]');
...
function updateVariables() {
	...
	postStatus = $('#marketPostStatus').val();
	// 정렬 순서
