...
$(document).ready(function() {
   ...
   function displayReviewData(pageDatas) {
      ...
      div.classList.add('freePostList', 'div');
      ...
      if (pageDatas.length <= 0) {
         ...
         pageDatas.forEach(function(freePostList) {
            ...
            const postDate = new Date(freePostList.freePostDate);
            ...
            console.log("freePostList.myRecommend : " + freePostList.myRecommend);
            var isAlreadyRecommended = freePostList.myRecommend === 1; // 1이면 true, 그 외에는 false
            ...
            if (!memberId) {
               recommendButtonHTML = `<a id="recommendBtnMessage" onclick="message()" class="love" style="margin-top:0%">
                            ...
                            <div id="recommendCnt">${freePostList.recommendCnt}</div>
                         </a>`;
            } else  {
               recommendButtonHTML = `<a id="recommendBtn_${freePostList.freePostId}" class="love ${isAlreadyRecommended ? 'active' : ''}" style="margin-top:0%" data-postid="${freePostList.freePostId}" data-memberid="${memberId}">
