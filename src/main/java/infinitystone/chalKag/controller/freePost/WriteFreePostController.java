...
public class WriteFreePostController {
  ...
  public String writeFreePost(FreePostDTO freePostDTO, MemberDTO memberDTO, PostImgDTO postImgDTO, HttpSession session, @RequestParam("file") MultipartFile[] files) {
