...
//         }
  ...
  public boolean insert(HeadHuntPostDTO headHuntPostDTO) {
    ...
    result = jdbcTemplate.update(INSERT_HEADHUNTPOST, headHuntPostDTO.getMemberId(), headHuntPostDTO.getHeadHuntPostRole(),
        headHuntPostDTO.getHeadHuntPostRegion(), headHuntPostDTO.getHeadHuntPostPay(), headHuntPostDTO.getHeadHuntPostWorkDate(),
        headHuntPostDTO.getHeadHuntPostConcept(), headHuntPostDTO.getHeadHuntPostTitle(), headHuntPostDTO.getHeadHuntPostContent());
    if (result <= 0) {
  ...
  public boolean update(HeadHuntPostDTO headHuntPostDTO) {
    ...
    // 구인글 수정
      ...
      result = jdbcTemplate.update(UPDATE_HEADHUNTPOST, headHuntPostDTO.getHeadHuntPostRole(), headHuntPostDTO.getHeadHuntPostRegion(),
