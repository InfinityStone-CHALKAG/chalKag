...
public class PostImgDAO {
	...
	private static final String SELECTALL_PREMIUMHEADHUNTPOSTIMG = "SELECT "
			...
			+ "LIMIT 1";
	private static final String SELECTALL_PREMIUMJOBHUNTPOSTIMG = "SELECT"
			+ " POSTIMG.POSTIMG_name, "
			+ "POSTIMG.POSTIMG_id, "
			...
			+ "	ORDER BY POSTIMG.POSTIMG_id DESC "
			+ " LIMIT 1 ";
	private static final String SELECTALL_PREMIUMFREEPOSTIMG = "SELECT "
			+ "POSTIMG.POSTIMG_name, "
			+ "POSTIMG.POSTIMG_id, "
			...
			+ "	ORDER BY POSTIMG.POSTIMG_id DESC "
			+ "	LIMIT 1";
	private static final String SELECTALL_PREMIUMMARKETPOSTIMG = "SELECT "
			+ "POSTIMG.POSTIMG_name, "
			+ "POSTIMG.POSTIMG_id, "
	...
	// 상세 보기 시 이미지 
	private static final String SELECTONE_HEADHUNTPOSTIMG = "SELECT "
			+ "POSTIMG.POSTIMG_name,"
			+ "POSTIMG.POSTIMG_id, "
			+ "HEADHUNTPOST.HEADHUNTPOST_id "
			+ "FROM POSTIMG "
	...
	private static final String SELECTONE_FREEPOSTIMG = "SELECT "
			+ "POSTIMG.POSTIMG_name,"
			+ "POSTIMG.POSTIMG_id, "
			+ " FREEPOST.FREEPOST_id "
			+ "	FROM POSTIMG "
	...
	private static final String SELECTONE_MARKETPOSTIMG = "SELECT "
			+ "POSTIMG.POSTIMG_name, "
			+ "POSTIMG.POSTIMG_id, "
			+ "MARKETPOST.MARKETPOST_id "
			+ "	FROM POSTIMG "
