...
//			String role = filterDTO.getRole();
//			if(filterDTO.getRole().equals("Model")) {
//				ROLESQL = "AND JOBHUNTPOST_role LIKE '%'||'"+role+"'||'%'";
//			}
//			if(filterDTO.getRole().equals("Photographer")) {
//				ROLESQL = "AND JOBHUNTPOST_role LIKE '%'||'"+role+"'||'%'";
//			}
//		}
//		
...
//		
//		// 작업 날짜 검색
//		if(filterDTO.getEndWorkDate()!=0) {
//			WORKDATESQL = "AND WORKDATESQL BETWEEN " + filterDTO.getStartWorkDate() + " AND " + filterDTO.getEndWorkDate();
//		}
//		
//
//		// 컨셉 검색
...
//						+ "WHERE CATEGORY='"
//						+ PRICESQL +"' "+REGIONSQL
//						+ " "+ CONCEPTSQL +" "+WORKDATESQL +"ORDER BY JOBHUNT_id ASC) "
